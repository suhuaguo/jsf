package com.ipd.fastjson.serializer;
...
import com.ipd.fastjson.annotation.JSONField;
import com.ipd.fastjson.annotation.JSONType;
...
public class ASMSerializerFactory implements Opcodes {
    ...
    public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "java/lang/Object",
                 new String[] {"org/apache/jsf/fastjson/serializer/ObjectSerializer"});

        {
            FieldVisitor fw = cw.visitField(ACC_PRIVATE, "nature", ASMUtils.getDesc(JavaBeanSerializer.class));
            fw.visitEnd();
        }
        ...
        for (FieldInfo fieldInfo : getters) {
            ...
            mw.visitLdcInsn(com.ipd.fastjson.asm.Type.getType(ASMUtils.getDesc(fieldInfo.getDeclaringClass())));

            if (fieldInfo.getMethod() != null) {
                mw.visitLdcInsn(fieldInfo.getMethod().getName());
                mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(ASMUtils.class), "getMethodType",
                                   "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Type;");

            } else {
                mw.visitLdcInsn(fieldInfo.getField().getName());
                mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(ASMUtils.class), "getFieldType",
                                   "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Type;");
            }
...

        {
            ...
            mw = cw.visitMethod(ACC_PUBLIC,
                                "write",
                                "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V",
                                null, new String[] { "java/io/IOException" });

            mw.visitVarInsn(ALOAD, context.serializer()); // serializer
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "getWriter",
            ...
            if (jsonType == null || jsonType.alphabetic()) {
                ...
                mw.visitFieldInsn(GETSTATIC, ASMUtils.getType(SerializerFeature.class), "SortField",
                                  "L" + ASMUtils.getType(SerializerFeature.class) + ";");
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "isEnabled",
                                   "(" + "L" + ASMUtils.getType(SerializerFeature.class) + ";" + ")Z");
    ...
    private void generateWriteAsArray(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context)
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "write", "(C)V");
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (propertyClass == byte.class //
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeIntAndChar", "(IC)V");

            } else if (propertyClass == long.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeLongAndChar", "(JC)V");

            } else if (propertyClass == float.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFloatAndChar", "(FC)V");

            } else if (propertyClass == double.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeDoubleAndChar", "(DC)V");

            } else if (propertyClass == boolean.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeBooleanAndChar", "(ZC)V");
            } else if (propertyClass == char.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeCharacterAndChar", "(CC)V");
                ...
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeEnum", "(Ljava/lang/Enum;C)V");
            } else {
                ...
                if (format != null) {
                    ...
                    mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "writeWithFormat",
                                       "(Ljava/lang/Object;Ljava/lang/String;)V");
                } else {
                    mw.visitVarInsn(ALOAD, context.fieldName());
                    if (property.getFieldType() instanceof Class<?> //
                        && ((Class<?>) property.getFieldType()).isPrimitive()) {
                        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "writeWithFieldName",
    ...
    private void generateWriteMethod(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context)
...

        {
            ...
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitFieldInsn(GETSTATIC, ASMUtils.getType(SerializerFeature.class), "PrettyFormat",
                              "L" + ASMUtils.getType(SerializerFeature.class) + ";");
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "isEnabled",
                               "(" + "L" + ASMUtils.getType(SerializerFeature.class) + ";" + ")Z");
            ...
            mw.visitVarInsn(ALOAD, 0);
            mw.visitFieldInsn(GETFIELD, context.getClassName(), "nature", ASMUtils.getDesc(JavaBeanSerializer.class));
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JavaBeanSerializer.class), "write",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V");
            mw.visitInsn(RETURN);
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "containsReference",
                               "(Ljava/lang/Object;)Z");
            ...
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 2);
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JavaBeanSerializer.class), "writeReference",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;)V");
...

        {
            ...
            mw.visitVarInsn(ALOAD, context.obj());
            mw.visitVarInsn(ALOAD, context.paramFieldType());
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "isWriteAsArray",
        ...
        {
            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "getContext",
                               "()Lcom/ipd/fastjson/serializer/SerialContext;");
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "setContext",
                               "(Lcom/ipd/fastjson/serializer/SerialContext;Ljava/lang/Object;Ljava/lang/Object;)V");
        }
        ...
        // SEPERATO
        {
            ...
            mw.visitVarInsn(ALOAD, context.paramFieldType());
            mw.visitVarInsn(ALOAD, context.obj());
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "isWriteClassName",
            ...
            mw.visitVarInsn(ALOAD, context.paramFieldType());
            mw.visitVarInsn(ALOAD, context.obj());
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(Object.class), "getClass", "()Ljava/lang/Class;");
            mw.visitJumpInsn(IF_ACMPEQ, else_);

            mw.visitLabel(writeClass_);
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn("{\"" + JSON.DEFAULT_TYPE_KEY + "\":\"" + clazz.getName() + "\"");
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "write", "(Ljava/lang/String;)V");
            mw.visitVarInsn(BIPUSH, ',');
        ...
        mw.visitVarInsn(ALOAD, context.var("parent"));
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "setContext",
                           "(Lcom/ipd/fastjson/serializer/SerialContext;)V");

    }

    private void initNature(Class<?> clazz, MethodVisitor mw, Context context) {
        mw.visitVarInsn(ALOAD, 0);
        mw.visitTypeInsn(NEW, ASMUtils.getType(JavaBeanSerializer.class));
        mw.visitInsn(DUP);
        mw.visitLdcInsn(com.ipd.fastjson.asm.Type.getType(ASMUtils.getDesc(clazz)));
        mw.visitMethodInsn(INVOKESPECIAL, ASMUtils.getType(JavaBeanSerializer.class), "<init>", "(" + ASMUtils.getDesc(Class.class)
                                                                                       + ")V");
        mw.visitFieldInsn(PUTFIELD, context.getClassName(), "nature", ASMUtils.getDesc(JavaBeanSerializer.class));
    }
    ...
    private void _long(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;J)V");
    ...
    private void _float(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;F)V");
    ...
    private void _double(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;D)V");
    ...
    private void _char(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;C)V");
    ...
    private void _boolean(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;Z)V");
    ...
    private void _get(MethodVisitor mw, Context context, FieldInfo property) {
        ...
        if (method != null) {
            ...
            mw.visitVarInsn(ALOAD, context.var("entity"));
            mw.visitFieldInsn(GETFIELD, ASMUtils.getType(property.getDeclaringClass()), property.getField().getName(),
    ...
    private void _byte(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;I)V");
    ...
    private void _list(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.var("out"));
        mw.visitVarInsn(ALOAD, context.fieldName());
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldName", "(Ljava/lang/String;)V");
...

        {
            ...
            mw.visitTypeInsn(CHECKCAST, ASMUtils.getType(ObjectSerializer.class)); // cast to string
            ...
            if (elementType == String.class) {
                ...
                if (elementClass != null && Modifier.isPublic(elementClass.getModifiers())) {
                    mw.visitLdcInsn(com.ipd.fastjson.asm.Type.getType(ASMUtils.getDesc((Class<?>) elementType)));
                    mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "writeWithFieldName",
                                       "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V");
                } else {
                    mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "writeWithFieldName",
        ...
        {
            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "popContext", "()V");
        }
    ...
    private void _filters(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        if (property.getField() != null) {
            if (Modifier.isTransient(property.getField().getModifiers())) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                mw.visitFieldInsn(GETSTATIC, ASMUtils.getType(SerializerFeature.class), "SkipTransientField",
                                  "L" + ASMUtils.getType(SerializerFeature.class) + ";");
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "isEnabled",
                                   "(" + "L" + ASMUtils.getType(SerializerFeature.class) + ";" + ")Z");
    ...
    private void _nameApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ALOAD, context.fieldName());
        mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "applyName",
                           "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;)Z");
        mw.visitJumpInsn(IFEQ, _end);
    }
    ...
    private void _before(MethodVisitor mw, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ILOAD, context.var("seperator"));
        mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "writeBefore",
                           "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;C)C");
        mw.visitVarInsn(ISTORE, context.var("seperator"));
    }
    ...
    private void _after(MethodVisitor mw, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ILOAD, context.var("seperator"));
        mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "writeAfter",
                           "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;C)C");
        mw.visitVarInsn(ISTORE, context.var("seperator"));
    }
    ...
    private void _apply(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            mw.visitVarInsn(ILOAD, context.var("byte"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Z");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Z");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Z");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Z");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Z");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Z");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
            ...
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
    ...
    private void _processValue(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            mw.visitVarInsn(ILOAD, context.var("byte"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(Byte.class), "valueOf", "(B)Ljava/lang/Byte;");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(Short.class), "valueOf", "(S)Ljava/lang/Short;");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(Integer.class), "valueOf", "(I)Ljava/lang/Integer;");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(Character.class), "valueOf", "(C)Ljava/lang/Character;");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(Long.class), "valueOf", "(J)Ljava/lang/Long;");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(Float.class), "valueOf", "(F)Ljava/lang/Float;");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(Double.class), "valueOf", "(D)Ljava/lang/Double;");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(Boolean.class), "valueOf", "(Z)Ljava/lang/Boolean;");
        } else if (propertyClass == BigDecimal.class) {
            mw.visitVarInsn(ALOAD, context.var("decimal"));
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
        ...
        mw.visitMethodInsn(INVOKESTATIC,
                           ASMUtils.getType(FilterUtils.class),
                           "processValue",
                           "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
    ...
    private void _processKey(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            mw.visitVarInsn(ILOAD, context.var("byte"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Ljava/lang/String;");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Ljava/lang/String;");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/String;");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Ljava/lang/String;");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Ljava/lang/String;");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Ljava/lang/String;");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Ljava/lang/String;");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Z)Ljava/lang/String;");
        } else if (propertyClass == BigDecimal.class) {
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC,
                               ASMUtils.getType(FilterUtils.class),
                               "processKey",
                               "(Lcom/ipd/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC,
                               ASMUtils.getType(FilterUtils.class),
    ...
    private void _if_write_null(MethodVisitor mw, FieldInfo fieldInfo, Context context) {
        ...
        if (!writeNull) {
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitFieldInsn(GETSTATIC, ASMUtils.getType(SerializerFeature.class), "WriteMapNullValue",
                              "L" + ASMUtils.getType(SerializerFeature.class) + ";");
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "isEnabled",
                               "(" + "L" + ASMUtils.getType(SerializerFeature.class) + ";" + ")Z");
            mw.visitJumpInsn(IFEQ, _else);
        ...
        if (propertyClass == String.class || propertyClass == Character.class) {
            if (writeNullStringAsEmpty) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNullString",
            ...
            if (writeNullNumberAsZero) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNullNumber",
                                   "(CLjava/lang/String;)V");
            }
        } else if (propertyClass == Boolean.class) {
            if (writeNullBooleanAsFalse) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNullBoolean",
                                   "(CLjava/lang/String;)V");
            }
        } else if (Collection.class.isAssignableFrom(propertyClass) || propertyClass.isArray()) {
            if (writeNullListAsEmpty) {
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldEmptyList",
                                   "(CLjava/lang/String;)V");
            } else {
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNullList",
                                   "(CLjava/lang/String;)V");
            }
        } else {
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNull",
                               "(CLjava/lang/String;)V");
        }
