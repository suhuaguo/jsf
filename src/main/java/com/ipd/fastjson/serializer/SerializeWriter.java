...
import static com.ipd.fastjson.parser.CharTypes.replaceChars;
...
import com.ipd.fastjson.parser.CharTypes;
import com.ipd.fastjson.JSON;
import com.ipd.fastjson.JSONException;
import com.ipd.fastjson.parser.CharTypes;
import com.ipd.fastjson.util.Base64;
                ...
                if (specialCount == 1) {
                    if (lastSpecial == '\u2028') {
                        ...
                        if (ch < CharTypes.specicalFlags_doubleQuotes.length //
                            ...
                            System.arraycopy(buf, srcPos, buf, destPos, LengthOfCopy);
                            buf[lastSpecialIndex] = '\\';
                            buf[++lastSpecialIndex] = CharTypes.replaceChars[(int) ch];
                        }
                    }
