...
import com.ipd.fastjson.annotation.JSONCreator;
...
public class DeserializeBeanInfo {
    ...
    /** TODO JSF ADD */
    public Object[] get_constructorArgs() {
        return _constructorArgs;
    }

    public void set_constructorArgs(Object[] _constructorArgs) {
        this._constructorArgs = _constructorArgs;
    }
        ...
        if (defaultConstructor != null) {
            ...
            if (constructor != null) {
                ...
                for (int i = 0; i < params.length; i++) {
                    args[i] = CodecUtils.getDefParamArg(params[i]);
                }
            }
            if(constructor != null){
                beanInfo.setDefaultConstructor(constructor);
                beanInfo.set_constructorArgs(args);
            } else {
                //TODO JSF ADD end
