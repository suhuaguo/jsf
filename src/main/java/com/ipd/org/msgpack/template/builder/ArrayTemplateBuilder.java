...
import com.ipd.org.msgpack.template.BooleanArrayTemplate;
import com.ipd.org.msgpack.template.ByteArrayTemplate;
import com.ipd.org.msgpack.template.DoubleArrayTemplate;
import com.ipd.org.msgpack.template.FieldList;
import com.ipd.org.msgpack.template.FloatArrayTemplate;
import com.ipd.org.msgpack.template.IntegerArrayTemplate;
import com.ipd.org.msgpack.template.LongArrayTemplate;
import com.ipd.org.msgpack.template.ObjectArrayTemplate;
import com.ipd.org.msgpack.template.ShortArrayTemplate;
    ...
    private Template toTemplate(Type arrayType, Type genericBaseType, Class baseClass, int dim) {
        if (dim == 1) {
            if (baseClass == boolean.class) {
                ...
                try {
                	baseTemplate = registry.lookup(genericBaseType);
                } catch (Exception e){
               		CodecUtils.checkAndRegistryClass(baseClass, new HashSet<Class<?>>());
                	baseTemplate = registry.lookup(genericBaseType);
                }
