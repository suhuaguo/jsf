 ...
 *
 */
public class JSFTimestampTemplate extends AbstractTemplate<Timestamp> {
	...
	private JSFTimestampTemplate(){}
	
	private static JSFTimestampTemplate instance = new JSFTimestampTemplate();
	
	public static JSFTimestampTemplate getInstance(){
		return instance;
	}
}