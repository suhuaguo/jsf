 ...
 * <p/>
 */
public class JSFUUIDTemplate extends AbstractTemplate<UUID> {

    private static final Logger logger = LoggerFactory.getLogger(JSFUUIDTemplate.class);
    ...
    private JSFUUIDTemplate(){}

    private static JSFUUIDTemplate instance = new JSFUUIDTemplate();

    public static JSFUUIDTemplate getInstance(){
        return instance;
    }
}