 ...
 * Title: 运行时状态的记录<br>
 * <p/>
 * Description: 包含一些并发，成功失败数的记录。<br>
 * <p/>
 */
public class RpcStatus {
     ...
     * 接口级统计
     */
    private static final ConcurrentMap<AbstractInterfaceConfig, RpcStatus> INTERFACE_STATISTICS = new ConcurrentHashMap<AbstractInterfaceConfig, RpcStatus>();

    /**
     * 方法级统计
     */
    private static final ConcurrentMap<AbstractInterfaceConfig, ConcurrentMap<String, RpcStatus>> METHOD_STATISTICS = new ConcurrentHashMap<AbstractInterfaceConfig, ConcurrentMap<String, RpcStatus>>();

    /**
     * 方法+provider级统计
     */
    private static final ConcurrentMap<String, RpcStatus> METHOD_PROVIDER_STATISTICS = new ConcurrentHashMap<String, RpcStatus>();
