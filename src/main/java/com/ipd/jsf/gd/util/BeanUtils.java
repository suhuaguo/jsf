        ...
        for (Method method : methods) {
            ...
            if (ReflectUtils.isBeanPropertyReadMethod(method)) {
                ...
                try {
                    ...
                    throw new InitErrorException("Can't access copy " + propertyName, e.getCause());
                } catch (IllegalAccessException e) {
                    throw new InitErrorException("Can't access copy " + propertyName, e);
                }
