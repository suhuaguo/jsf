...
import com.ipd.jsf.gd.filter.ExcludeFilter;
...
/**
 * Title: Spring解析器，将配置的属性转为javabean的属性<br>
 * <p/>
 * Description: 有些特殊处理<br>
 * <p/>
 */
                ...
                if (node instanceof Element) {
                    if ("parameter".equals(node.getNodeName())
                        ...
                        if (!StringUtils.isValidParamKey(key)) {
                            throw new IllegalConfigureException(21000, "param.key", key, "key can not start with "
                ...
                if (node instanceof Element) {
                    ...
                    if ("consumer".equals(node.getNodeName()) || "consumer".equals(node.getLocalName())) {
                        ...
                        if (consumerConfigs.containsKey(alias)) {
                            throw new IllegalConfigureException(21318, "consumerGroup.alias", alias,
