...
public class ConsumerGroupBean<T> extends ConsumerGroupConfig<T> implements InitializingBean, FactoryBean,
     ...
     *
     */
    private static final long serialVersionUID = -303495390952355169L;
    ...
    public void destroy() throws Exception {
        LOGGER.info("JSF destroy consumer group with bean name : {}", beanName);
        super.unrefer();
    }
}