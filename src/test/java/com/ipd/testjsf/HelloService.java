...
public interface HelloService {
    ...
    public void callBackString(String request, Callback<String, String> resultListener);
    public void callBackList(String request, Callback<List<List<String>>, List<List<String>>> resultListener);
    public void callBackObj(String request, Callback<TestObj, TestObj> resultListener);
